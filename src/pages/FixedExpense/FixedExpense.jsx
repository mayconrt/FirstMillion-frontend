...
import { init, create, update, remove } from '../../store/fixedExpense/fixedActions'
                ...
                <Tabs>
                    ...
                    <TabsContent>
                        <TabContent id='tabList'>
                            <FixedTable taId='tabList'/>
                        </TabContent>
                        <TabContent id='tabInclude'>
                            <FixedForm onSubmit={this.props.create} tabId='tabInclude'/>
                        </TabContent>
                        <TabContent id='tabEdit'>
                            <FixedForm  onSubmit={this.props.update} tabId='tabEdit'/>
                        </TabContent>
                        <TabContent id='tabDelete'>
                            <FixedForm  onSubmit={this.props.remove} readOnly={true} tabId='tabDelete'/>
                        </TabContent>                       
                    </TabsContent>
                </Tabs>
            </div>
